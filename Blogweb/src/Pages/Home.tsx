  ...
  return (
    <main className="blogs_posts">
      {popularFetch.length > 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-center my-4">
          <Load />
          <Load />
          <Load />
        </div>
...
const SecondPopularPosts = () => {
  ...
  const fetchPopularPosts = async () => {
    try {
      ...
      if (response.status === 200) {
        setPopularFetch(response.data.slice(3, 6));
      }
    } catch (error) {
      console.error(error);
    }
  ...
  return (
    <main className="blogs_posts max-w-[90%] sm:max-w-[80%] mx-auto">
      ...
      {popularFetch.length > 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-center my-8">
          <Load />
          <Load />
          <Load />
        </div>
